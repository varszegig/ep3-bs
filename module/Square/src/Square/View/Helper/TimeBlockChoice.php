...
class TimeBlockChoice extends AbstractHelper
{
    ...
    protected function renderDateBlockChoice(DateTime $dateTimeStart, DateTime $dateTimeEnd, Square $square)
    {
        ...
        $html .= '<input type="text" name="sb-date-start-choice" id="sb-date-start-choice" value="' . $view->dateFormat($dateTimeStart, IntlDateFormatter::MEDIUM, null, null, $this->t('dd.MM.yyyy')) . '" class="inline-label-container datepicker" style="padding-left: 28px; width: 96px;">';
        $html .= '</div>';
        ...
        $html .= '<input type="text" name="sb-date-end-choice" id="sb-date-end-choice" value="' . $view->dateFormat($dateTimeEnd, IntlDateFormatter::MEDIUM, null, null, $this->t('dd.MM.yyyy')) . '" class="inline-label-container datepicker" style="padding-left: 28px; width: 96px;">';
        $html .= '</div>';
